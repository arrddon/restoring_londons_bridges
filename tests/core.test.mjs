...
test('Albert Bridge uses updated pins and starts at A01', () => {
  ...
  assert.equal(a04.assetType, 'image');
  assert.equal(a04.destination, '/AlbertBridge/A04');
  assert.equal(a04.imagePath, 'https://res.cloudinary.com/douz9wtb2/image/upload/v1789592433/A04_image_yvykoy.jpg');
});
