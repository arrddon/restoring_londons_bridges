...
test('Hammersmith routes receive specific browser titles', () => {
  ...
  assert.equal(pageTitle(['HammersmithBridge', 'Guide-H01'], bridges), '01. Coat of Arms — Print QR Guide');
  assert.equal(pageTitle(['HammersmithBridge', 'H01'], bridges), '01. Coat of Arms — Hammersmith Bridge');
  assert.equal(pageTitle(['HammersmithBridge', 'H01', 'ar'], bridges), '01. Coat of Arms AR — Hammersmith Bridge');
});
